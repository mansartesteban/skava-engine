...
import { R as RGB, V as Vector2, a as Rotation } from "./Vector2-BXEmxqj7.mjs";
...
class RoundSquare {
  constructor(position = new Vector2(), size = new Vector2(), radius = [0], color = new RGB(), rotation = new Rotation()) {
...
class Text {
  constructor(text = "", position = new Vector2(), color = RGB.White, fontSize = 10) {
...
//# sourceMappingURL=Text-D3wvtlzW.mjs.map
