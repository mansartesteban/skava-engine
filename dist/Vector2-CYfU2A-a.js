...
const _RGB = class _RGB {
   ...
   */
  set r(r) {
    __privateSet(this, _r, Utils_Numeric.clamp(r, 0, 255));
  }
  /**
   ...
   */
  set g(g) {
    __privateSet(this, _g, Utils_Numeric.clamp(g, 0, 255));
  }
  /**
   ...
   */
  set b(b) {
    __privateSet(this, _b, Utils_Numeric.clamp(b, 0, 255));
  }
  /**
...
const _Rotation = class _Rotation {
  ...
  constructor(angle, asRadian) {
    ...
    __privateSet(this, _angle, asRadian ? angle : Utils_Numeric.degreesToRadians(angle));
  }
  /**
   ...
   */
  get toDegrees() {
    return Utils_Numeric.radiansToDegrees(this.angle);
  }
  /**
...
const _Vector2 = class _Vector2 {
   ...
   */
  lerp(target, weight) {
    weight = Utils_Numeric.clamp(weight, 0, 1);
...
//# sourceMappingURL=Vector2-CYfU2A-a.js.map
